...
public class PathsInJava7 {
	...
	private static void buildPath() throws IOException {
		Path path = Paths.get(HOME_DIR,  "Personal", "Courses", "CoreJava", "Test.txt");
		...
		Path redundantPath = Paths.get(HOME_DIR, "Personal", "Courses", "CoreJava", ".","Test.txt");
		...
		Path partialPath = Paths.get(HOME_DIR, "Personal", "Courses", "CoreJava");
